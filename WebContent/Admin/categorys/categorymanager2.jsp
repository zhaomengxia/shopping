...
<body style="background-color: buttonhighlight;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="category_name" value="${list2.category_name}"/><a>类名：</a>
	<select id="category_name" name="category" onchange="getProductBycateId()">
	<option value="0">请选择类名：</option>
	<c:forEach items="${list2}" var="ca">
	<c:if test="${p.categoryID==ca.categoryID}">
	...
	<form action="${pageContext.request.contextPath}/Admin/products/proServlet?p=dodelmany" method="post">
