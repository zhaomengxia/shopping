...
<input type="submit" value="搜索"/>
	...
	<form action="${pageContext.request.contextPath}/Admin/orders/OrderTwoServlet?p=dodelmany" method="post">
		<h1>订单</h1>
		<table width="1100" border="1" align="center" cellpadding="0" cellspacing="0" style="background-color: maroon;">
			<tr>
			...
			<tr>
				<td colspan="8" align="center"><c:if
						...
						<a
							href="${pageContext.request.contextPath}/Admin/orders/OrderTwoServlet?p=doma3&currentPage=${proPage1.firstPage}&PageSize=10">首页</a>&nbsp&nbsp&nbsp&nbsp
				</c:if> <c:if test="${proPage1.currentPage==proPage1.firstPage}">
						<a>上一页</a>
					</c:if> <c:if test="${proPage1.currentPage!=proPage1.firstPage }">
						<a
							href="${pageContext.request.contextPath}/Admin/orders/OrderTwoServlet?p=doma3&currentPage=${proPage1.upPage}&PageSize=10">上一页</a>&nbsp&nbsp&nbsp&nbsp
					...
					第${proPage1.currentPage}页&nbsp&nbsp&nbsp&nbsp <c:if
						...
						<a
							href="${pageContext.request.contextPath}/Admin/orders/OrderTwoServlet?p=doma3&currentPage=${proPage1.downPage}&PageSize=10">下一页</a>&nbsp&nbsp&nbsp&nbsp
		</c:if> &nbsp&nbsp&nbsp&nbsp <c:if
						test="${proPage1.currentPage!=proPage1.totalPage}">
						<a
							href="${pageContext.request.contextPath}/Admin/orders/OrderTwoServlet?p=doma3&currentPage=${proPage1.totalPage}&PageSize=10">尾页</a>&nbsp&nbsp&nbsp&nbsp
		</c:if> &nbsp&nbsp&nbsp&nbsp <c:if
						test="${proPage1.currentPage==proPage1.totalPage}">
						<a>尾页</a>
