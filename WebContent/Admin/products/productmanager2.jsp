...
<body style="background-color:lightskyblue ">
	...
	<form action="${pageContext.request.contextPath}/Admin/products/proServlet?p=searchProduct&currentPage=1&PageSize=10" method="post">
	...
	<form action="${pageContext.request.contextPath}/Admin/products/proServlet?p=dodelmany" method="post" enctype="multipart/form-data">
		...
		<table width="900" border="1" align="center" cellpadding="0"
			...
			<tr>
				...
				<c:if test="${proPage.currentPage!=proPage.firstPage}">
				<a href="${pageContext.request.contextPath}/Admin/products/proServlet?p=doma&currentPage=${proPage.firstPage}&PageSize=10">首页</a>&nbsp&nbsp&nbsp&nbsp
				</c:if> 
		<c:if test="${proPage.currentPage==proPage.firstPage}">
						<a>上一页</a>
		</c:if> 
		<c:if test="${proPage.currentPage!=proPage.firstPage }">
		<a href="${pageContext.request.contextPath}/Admin/products/proServlet?p=doma&currentPage=${proPage.upPage}&PageSize=10">上一页</a>&nbsp&nbsp&nbsp&nbsp
		...
		<a href="${pageContext.request.contextPath}/Admin/products/proServlet?p=doma&currentPage=${proPage.downPage}&PageSize=10">下一页</a>&nbsp&nbsp&nbsp&nbsp
		</c:if> 
		<c:if test="${proPage.currentPage!=proPage.totalPage}">
		<a href="${pageContext.request.contextPath}/Admin/products/proServlet?p=doma&currentPage=${proPage.totalPage}&PageSize=10">尾页</a>&nbsp&nbsp&nbsp&nbsp
		</c:if> 
		<c:if test="${proPage.currentPage==proPage.totalPage}">
		<a>尾页</a>
		</c:if> 
