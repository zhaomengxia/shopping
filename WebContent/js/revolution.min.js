(function (b) {
    ...
    var S = "left", T = "right", ad = "up", G = "down", af = "in", E = "out", V = "none", L = "auto", W = "swipe", K = "pinch", R = "tap", Y = "doubletap", ag = "longtap", F = "hold", M = "horizontal", J = "vertical", Z = "all", O = 10, ab = "start", X = "move", aa = "end", Q = "cancel", ah = "ontouchstart" in window, I = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled, ae = window.navigator.pointerEnabled || window.navigator.msPointerEnabled, P = "TouchSwipe";
    var U = {
        fingers: 1,
        threshold: 75,
    ...
    function N(bT, D) {
        var v = (ah || ae || !D.fallbackToMouseEvents), t = v ? (ae ? (I ? "MSPointerDown" : "pointerdown") : "touchstart") : "mousedown", x = v ? (ae ? (I ? "MSPointerMove" : "pointermove") : "touchmove") : "mousemove", h = v ? (ae ? (I ? "MSPointerUp" : "pointerup") : "touchend") : "mouseup", j = v ? null : "mouseleave", bK = (ae ? (I ? "MSPointerCancel" : "pointercancel") : "touchcancel");
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (D, y, v) {
        ...
        }, b = 1e-10, j = v._internals, A = j.isSelector, g = j.isArray, w = j.lazyTweens, q = j.lazyRender, B = [], C = _gsScope._gsDefine.globals, z = function (c) {
            var f, a = {};
            for (f in c) {
                a[f] = c[f]
            }
        ...
        return E.version = "1.14.2", k.constructor = E, k.kill()._gc = k._forcingPlayhead = !1, k.to = function (a, h, c, f) {
            ...
            var O, r, L, l, M, K = this._dirty ? this.totalDuration() : this._totalDuration, h = this._time, H = this._startTime, F = this._timeScale, J = this._paused;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (au, aN) {
        ...
        var aJ, at, aM, az, aU, aP, aO = /(?:\d|\-\d|\.\d|\-\.\d)+/g, aC = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, aL = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, ar = /(?![+-]?\d*\.?\d+|e[+-]\d+)[^0-9]/g, ao = /(?:\d|\-|\+|=|#|\.)*/g, ap = /opacity *= *([^)]*)/i, a1 = /opacity:([^;]*)/i, aq = /alpha\(opacity *=.+?\)/i, aS = /^(rgb|hsl)/, a6 = /([A-Z])/g, a3 = /-([a-z])/gi, a4 = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, bq = function (a, b) {
            return b.toUpperCase()
        }, aG = /(?:Left|Right|Width)/i, a7 = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, bs = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, bn = /,(?=[^\)]*(?:\(|$))/gi, bb = Math.PI / 180, bc = 180 / Math.PI, a9 = {}, an = document, aX = an.createElement("div"), bg = an.createElement("img"), bm = aT._internals = {_specialProps: aA}, bl = navigator.userAgent, aW = function () {
        ...
        var a8 = function (w, p, j, b) {
            ...
            var x, d = p ? (w.match(bE) || [""])[0] : "", q = w.split(d).join("").match(aL) || [], c = w.substr(0, w.indexOf(q[0])), g = ")" === w.charAt(w.length - 1) ? ")" : "", k = -1 !== w.indexOf(" ") ? " " : ",", v = q.length, m = v > 0 ? q[0].replace(aO, "") : "";
            ...
            var U, I, Y, W, Q, B, q, z, b, A, j, d, h = N.split(", ").join(",").split(" "), G = H.split(", ").join(",").split(" "), M = h.length, m = aJ !== !1;
        ...
        var am, bA = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), bH = aZ("transform"), bB = aH + "transform", ag = aZ("transformOrigin"), a2 = null !== aZ("perspective"), aR = bm.Transform = function () {
            this.skewY = 0
            ...
            var ce, cd, cg, ck, b8, cm, cc, cs, cp, co, cf, cl, b7, b3 = cj ? b9._gsTransform || new aR : new aR, b5 = 0 > b3.scaleX, bJ = 0.00002, b6 = 100000, cq = 179.99, bN = cq * bb, bK = a2 ? parseFloat(bj(b9, ag, cn, !1, "0 0 0").split(" ")[2]) || b3.zOrigin || 0 : 0, bL = parseFloat(aT.defaultTransformPerspective) || 0;
            if (bH ? ce = bj(b9, bB, cn, !0) : b9.currentStyle && (ce = b9.currentStyle.filter.match(a7), ce = ce && 4 === ce.length ? [ce[0].substr(4), Number(ce[2].substr(4)), Number(ce[1].substr(4)), ce[3].substr(4), b3.x || 0, b3.y || 0].join(",") : ""), ce && "none" !== ce && "matrix(1, 0, 0, 1, 0, 0)" !== ce) {
                ...
                if (16 === cd.length) {
                    ...
                    if (b3.zOrigin && (b2 = -b3.zOrigin, bV = bW * b2 - cd[12], bO = ch * b2 - cd[13], b2 = bY * b2 + b3.zOrigin - cd[14]), !cj || ca || null == b3.rotationX) {
                        var L, bR, bU, bT, H, bX, be, ci = cd[0], O = cd[1], ae = cd[2], cb = cd[3], bS = cd[4], bM = cd[5], s = cd[6], b0 = cd[7], bP = cd[11], bQ = Math.atan2(s, bY), M = -bN > bQ || bQ > bN;
                    ...
                    if (!(a2 && !ca && cd.length && b3.x === cd[4] && b3.y === cd[5] && (b3.rotationX || b3.rotationY) || void 0 !== b3.x && "none" === bj(b9, "display", cn))) {
                        var cr = cd.length >= 6, b1 = cr ? cd[0] : 1, b4 = cd[1] || 0, bZ = cd[2] || 0, a = cr ? cd[3] : 1;
            ...
            var O, K, E = this.data, B = -E.rotation * bb, H = B + E.skewX * bb, V = 100000, G = (0 | Math.cos(B) * E.scaleX * V) / V, J = (0 | Math.sin(B) * E.scaleX * V) / V, L = (0 | Math.sin(H) * -E.scaleY * V) / V, z = (0 | Math.cos(H) * E.scaleY * V) / V, N = this.t.style, F = this.t.currentStyle;
            if (F) {
                K = J, J = -L, L = -K, O = F.filter, N.filter = "";
                var W, Q, I = this.t.offsetWidth, M = this.t.offsetHeight, y = "absolute" !== F.position, c = "progid:DXImageTransform.Microsoft.Matrix(M11=" + G + ", M12=" + J + ", M21=" + L + ", M22=" + z, x = E.x + I * E.xPercent / 100, U = E.y + M * E.yPercent / 100;
            ...
            var bS, bO, ae, Y, bK, bW, bJ, bM, bP, U, bR, bX, bU, bT, bL, bQ, Q, J, K, p, M, bV, E, q = this.data, B = this.t.style, Z = q.rotation * bb, bN = q.scaleX, F = q.scaleY, be = q.scaleZ, W = q.x, H = q.y, G = q.z, I = q.perspective;
        ...
        bw("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            parser: function (s, I, E, w, B, A, D) {
                ...
                var F, q, H, z, L, K, J, C = w._transform = bD(s, av, !0, D.parseTransform), G = s.style, k = 0.000001, b = bA.length, j = D, a = {};
            ...
            defaultValue: "0 0", parser: function (E, z, v, b, k, B) {
                var j, s, w, D, y, c, C = "background-position", A = av || ay(E, null), q = this.format((A ? aP ? A.getPropertyValue(C + "-x") + " " + A.getPropertyValue(C + "-y") : A.getPropertyValue(C) : E.currentStyle.backgroundPositionX + " " + E.currentStyle.backgroundPositionY) || "0 0"), x = this.format(z);
...
(function (w) {
    var J = w.GreenSockGlobals || w, F = function (c) {
        ...
        return f
    }, q = ")eefec303079ad17405c", L = /(?:<br>|<br\/>|<br \/>)/gi, A = C.all && !C.addEventListener, I = "<div style='position:relative;display:inline-block;" + (A ? "*display:inline;*zoom:1;'" : "'"), D = function (c) {
        c = c || "";
        ...
        var aD, aL, aB, aH, aJ, av, u, ax, aK, aw, ac, v, ap, aE, aa = z(ay), ar = aI.type || aI.split || "chars,words,lines", ad = -1 !== ar.indexOf("lines") ? [] : null, ao = -1 !== ar.indexOf("words"), af = -1 !== ar.indexOf("chars"), ag = "absolute" === aI.position || aI.absolute === !0, au = ag ? "&#173; " : " ", aj = -999, an = M(ay), ae = G(ay, "paddingLeft", an), am = G(ay, "borderBottomWidth", an) + G(ay, "borderTopWidth", an), g = G(ay, "borderLeftWidth", an) + G(ay, "borderRightWidth", an), r = G(ay, "paddingTop", an) + G(ay, "paddingBottom", an), aq = G(ay, "paddingLeft", an) + G(ay, "paddingRight", an), aF = G(ay, "textAlign", an, !0), c = ay.clientHeight, aA = ay.clientWidth, al = "</div>", n = D(aI.wordsClass), ab = D(aI.charsClass), m = -1 !== (aI.linesClass || "").indexOf("++"), ak = aI.linesClass, a = -1 !== aa.indexOf("<"), at = !0, ah = [], ai = [], h = [];
...
(function (a2, aK) {
    ...
    function aM(G, R) {
        ...
        if (!G.hasClass("revslider-initialised")) {
            ...
            R.origcd = R.delay;
            var W = a2.fn.jquery.split("."), q = parseFloat(W[0]), u = parseFloat(W[1]), c = parseFloat(W[2] || "0");
            if (q == 1 && u < 7) {
            ...
            if (R.shuffle == "on") {
                var n = new Object, J = G.find(">ul:first-child >li:first-child");
    ...
    var aJ = function (g, b) {
        ...
        if (a2(window).width() < b.hideSliderAtLimit) {
            ...
            if (g.is(":hidden")) {
                if (q.data("olddisplay") != aK && q.data("olddisplay") != "undefined" && q.data("olddisplay") != "none") {
                    q.css({display: q.data("olddisplay")})
                } else {
                    q.css({display: "block"})
                }
        ...
        try {
            g.parent().find(".tp-bannershadow").css({width: b.width, left: d})
        } catch (j) {
        }
        var p = g.find(">ul >li:eq(" + b.act + ") .slotholder");
        var k = g.find(">ul >li:eq(" + b.next + ") .slotholder");
        aw(g, b, g);
        punchgs.TweenLite.set(k.find(".defaultimg"), {opacity: 0});
        p.find(".defaultimg").css({opacity: 1});
        ...
        if (m.hasClass("preview2")) {
            m.css({width: parseInt(m.css("minWidth"), 0)})
        }
        aW(h, b, true);
        aI(g, b)
    };
    ...
    var aI = function (B, H) {
        ...
        if (H.navigationArrows != "none" && H.navigationArrows != "nexttobullets") {
            var P = H.soloArrowLeftValign, L = H.soloArrowLeftHalign, F = H.soloArrowRightValign, O = H.soloArrowRightHalign, x = H.soloArrowLeftVOffset, I = H.soloArrowLeftHOffset, M = H.soloArrowRightVOffset, k = H.soloArrowRightHOffset;
            ...
            if (O == "center") {
                z.css({left: "50%", marginLeft: R + k - Math.round(z.innerWidth() / 2) + "px"})
            } else {
                if (O == "left") {
                    z.css({left: N + k + R + "px"})
                } else {
                    if (O == "right") {
                        z.css({right: N + k - R + "px"})
                    }
                }
            }
            if (G.position() != null) {
        ...
        var Q = H.navigationVAlign, q = H.navigationHAlign, A = H.navigationVOffset * H.bh, j = H.navigationHOffset * H.bw;
        if (Q == "center") {
        ...
        if (q == "center") {
            K.css({left: "50%", marginLeft: R + j - Math.round(K.innerWidth() / 2) + "px"})
        }
        if (q == "left") {
            K.css({left: 0 + j + R + "px"})
        }
        if (q == "right") {
            K.css({right: 0 + j - R + "px"})
        }
    };
    var aS = function (q) {
        var b = q.container;
        ...
        var x = b.find(">ul:first-child >li:eq(" + q.comingli + ")"), G = b.find(">ul:first-child >li:eq(" + q.beforli + ")"), k = G.find(".defaultimg").attr("src"), F = x.find(".defaultimg").attr("src");
        if (q.arr == aK) {
        ...
        var D = q.arr, A = q.rar, w = q.lar, C = q.raimg, y = q.laimg, j = q.raimg_b, B = q.laimg_b, E = q.ratit, t = q.latit;
        if (x.data("title") != aK) {
            E.html(x.data("title"))
        }
        if (G.data("title") != aK) {
        ...
        if (!D.hasClass("preview4")) {
            ...
            B.css({backgroundImage: "url(" + k + ")"});
            punchgs.TweenLite.fromTo(j, 0.8, {force3D: punchgs.force3d, x: 0}, {
                x: -C.width(),
                ease: punchgs.Power3.easeOut,
                delay: 1,
                onComplete: function () {
                    C.css({backgroundImage: "url(" + F + ")"});
                    punchgs.TweenLite.set(j, {x: 0})
                }
            });
    ...
    var aF = function (b, a) {
        ...
        b.find(">ul:first >li").each(function (j) {
            ...
            g.css({width: "100%", height: "100%", overflow: "hidden"});
            if (g.data("link") != aK) {
                var h = g.data("link");
                var l = "_self";
                var d = 60;
        ...
        b.find(">ul:first >li >img").each(function (q) {
            ...
            if (h.data("lazyload") != aK && h.data("lazydone") != 1) {
            } else {
                aZ(h, a)
            }
            if (a6(8)) {
            ...
            var j = h.attr("src"), m = h.data("lazyload"), g = h.data("bgfit"), k = h.data("bgrepeat"), d = h.data("bgposition");
            if (g == aK) {
                g = "cover"
            }
            if (k == aK) {
            ...
            if (a6(8)) {
                p.find(".tp-bgimg").css({backgroundImage: "none", "background-image": "none"});
    ...
    var a5 = function (Q, I, F, M) {
        var B = Q, H = B.find(".defaultimg"), z = B.data("zoomstart"), P = B.data("rotationstart");
        ...
        aZ(H, I);
        var K = H.data("src"), U = H.css("backgroundColor"), O = I.width, G = I.height, R = H.data("fxof"), w = 0;
        if (I.autoHeight == "on") {
        ...
        var J = 0, q = H.data("bgfit"), V = H.data("bgrepeat"), A = H.data("bgposition");
        if (q == aK) {
            q = "cover"
        }
        if (V == aK) {
            ...
            case"box":
                ...
                for (var D = 0; D < I.slots; D++) {
                    ...
                    for (var L = 0; L < I.slots; L++) {
                        ...
                        if (z != aK && P != aK) {
                            punchgs.TweenLite.set(B.find(".slot").last(), {rotationZ: P})
                        }
                    }
                    a = a + t
                }
    ...
    var aH = function (d, b) {
        if (a6(8)) {
            ...
            setTimeout(function () {
                var j = f.width(), g = f.height(), h = d.data("bgposition");
                if (h == "center center") {
                    f.css({position: "absolute", top: b.height / 2 - g / 2 + "px", left: b.width / 2 - j / 2 + "px"})
                }
                if (h == "center top" || h == "top center") {
                    f.css({position: "absolute", top: "0px", left: b.width / 2 - j / 2 + "px"})
                }
                if (h == "center bottom" || h == "bottom center") {
                    f.css({position: "absolute", bottom: "0px", left: b.width / 2 - j / 2 + "px"})
                }
                ...
                if (h == "right center" || h == "center right") {
                    f.css({position: "absolute", top: b.height / 2 - g / 2 + "px", right: "0px"})
                }
                if (h == "left bottom" || h == "bottom left") {
                    f.css({position: "absolute", bottom: "0px", left: "0px"})
                }
                if (h == "left center" || h == "center left") {
                    f.css({position: "absolute", top: b.height / 2 - g / 2 + "px", left: "0px"})
                }
            }, 20)
        }
    };
    ...
    var ao = function (bQ, bK, bV, bJ, bO, bI) {
        ...
        var bY = 0, bS = bV.data("transition").split(","), b0 = bV.data("nexttransid") == aK ? -1 : bV.data("nexttransid");
        ...
        bt.add(punchgs.TweenLite.set(bI.find(".defaultimg"), {opacity: 0}));
        bt.pause();
        ...
        if (bY == 1) {
            ...
            bI.find(".slotslide").each(function (d) {
                var g = a2(this), c = Math.random() * bf + 300, f = Math.random() * 500 + 200;
                if (c + f > be) {
                    be = f + f;
                    bg = d
                }
        ...
        if (bY == 4 || bY == 5) {
            setTimeout(function () {
                bO.find(".defaultimg").css({opacity: 0})
            }, 100);
            var bs = bf / 1000, bd = bs, b1 = new punchgs.TimelineLite;
        ...
        if (bY == 12 || bY == 13 || bY == 14 || bY == 15) {
            ...
            setTimeout(function () {
                punchgs.TweenLite.set(bO.find(".defaultimg"), {autoAlpha: 0})
            }, 100);
            var bu = bK.width, bp = bK.height, bl = bI.find(".slotslide"), bL = 0, bb = 0, Q = 1, bD = 1, t = 1, j = punchgs.Power2.easeInOut, A = punchgs.Power2.easeInOut, bC = bf / 1000, bj = bC;
        ...
        if (bY == 16) {
            var b1 = new punchgs.TimelineLite;
            bt.add(punchgs.TweenLite.set(bJ, {position: "absolute", "z-index": 20}), 0);
            bt.add(punchgs.TweenLite.set(bV, {position: "absolute", "z-index": 15}), 0);
            ...
            bJ.find(".tp-half-two .defaultimg").css({position: "absolute", top: "-50%"});
            ...
            var b = bJ.find(".defaultimg"), a = Math.round(Math.random() * 20 - 10), bM = Math.round(Math.random() * 20 - 10), bU = Math.round(Math.random() * 20 - 10), bA = Math.random() * 0.4 - 0.2, bx = Math.random() * 0.4 - 0.2, bn = Math.random() * 1 + 1, bz = Math.random() * 1 + 1, bB = Math.random() * 0.3 + 0.3;
            bt.add(punchgs.TweenLite.set(bJ.find(".tp-half-one"), {overflow: "hidden"}), 0);
            bt.add(punchgs.TweenLite.fromTo(bJ.find(".tp-half-one"), bf / 800, {
                ...
                force3D: "auto",
                transformOrigin: "center top"
            }, {scale: bn, rotation: a, y: 0 - bp - bp / 4, autoAlpha: 0, ease: punchgs.Power2.easeInOut}), 0);
            bt.add(punchgs.TweenLite.fromTo(bJ.find(".tp-half-two"), bf / 800, {
                ...
                autoAlpha: 0,
                onComplete: function () {
                    punchgs.TweenLite.set(bJ, {position: "absolute", "z-index": 15});
                    punchgs.TweenLite.set(bV, {position: "absolute", "z-index": 20});
            ...
            b1.add(punchgs.TweenLite.set(bI.find(".defaultimg"), {autoAlpha: 1}), 0);
            if (bJ.html() != null) {
        ...
        if (bY == 19 || bY == 22) {
            var b1 = new punchgs.TimelineLite;
            bt.add(punchgs.TweenLite.set(bJ, {zIndex: 20}), 0);
            bt.add(punchgs.TweenLite.set(bV, {zIndex: 20}), 0);
            setTimeout(function () {
                bO.find(".defaultimg").css({opacity: 0})
            }, 100);
            var a9 = bV.css("z-index"), bw = bJ.css("z-index"), by = 90, Q = 1, bv = "center center ";
            if (a8 == 1) {
                by = -90
            }
            if (bY == 19) {
            ...
            bI.find(".slotslide").each(function (c) {
                ...
                b1.add(punchgs.TweenLite.to(d, 0.1, {autoAlpha: 1, delay: c * 50 / 1000}), 0);
                bt.add(b1)
            });
            bO.find(".slotslide").each(function (d) {
                var f = a2(this);
        ...
        if (bY == 20) {
            ...
            var a9 = bV.css("z-index"), bw = bJ.css("z-index");
            if (a8 == 1) {
                var bP = -bK.width;
                var by = 70;
            ...
            bI.find(".slotslide").each(function (c) {
                ...
                bt.add(punchgs.TweenLite.to(d, 0.1, {opacity: 1, force3D: "auto", delay: c * 50 / 1000 + bf / 2000}), 0)
            });
            bO.find(".slotslide").each(function (d) {
                var h = a2(this);
                if (a8 != 1) {
        ...
        if (bY == 21 || bY == 25) {
            ...
            var a9 = bV.css("z-index"), bw = bJ.css("z-index"), by = 90, bP = -bK.width, bk = -by;
            if (a8 == 1) {
                if (bY == 25) {
                    var bv = "center top 0";
                    by = bK.rotate
        ...
        if (bY == 23 || bY == 24) {
            ...
            var a9 = bV.css("z-index"), bw = bJ.css("z-index"), by = -90, Q = 1, bc = 0;
            if (a8 == 1) {
                by = 90
            }
            if (bY == 23) {
            ...
            punchgs.TweenLite.set(bQ, {transformStyle: "preserve-3d", backfaceVisibility: "hidden", perspective: 2500});
            bI.find(".slotslide").each(function (c) {
                var d = a2(this);
                bt.add(punchgs.TweenLite.fromTo(d, bf / 1000, {
                    left: bc,
        ...
        bt.pause();
        aW(bV, bK, null, bt);
        punchgs.TweenLite.to(bV, 0.001, {autoAlpha: 1});
        var bq = {};
    ...
    var a7 = function (b, g) {
        var d = $f(b), a = a2("#" + b), c = a.closest(".tp-simpleresponsive"), f = a.closest(".tp-caption");
        setTimeout(function () {
    ...
    var aW = function (j, a, m, y) {
        ...
        var t = j.data("ctl"), k = 0, w = 0, q = j.find(".tp-caption"), b = a.container.find(".tp-static-layers").find(".tp-caption");
        t.pause();
        a2.each(b, function (d, c) {
            q.push(c)
        });
        q.each(function (bA) {
            var bv = m, bI = -1, bF = a2(this);
            ...
            if (bH == 0) {
                ...
                if (bF.hasClass("tp-videolayer") || bF.find("iframe").length > 0 || bF.find("video").length > 0) {
                    var bq = "iframe" + Math.round(Math.random() * 100000 + 1), bM = bF.data("videowidth"), bs = bF.data("videoheight"), a9 = bF.data("videoattributes"), u = bF.data("ytid"), br = bF.data("vimeoid"), o = bF.data("videpreload"), H = bF.data("videomp4"), bb = bF.data("videowebm"), bC = bF.data("videoogv"), J = bF.data("videocontrols"), bc = "http", bE = bF.data("videoloop") == "loop" ? "loop" : bF.data("videoloop") == "loopandnoslidestop" ? "loop" : "";
                                            ...
                                            if (typeof YT.Player != aK && typeof YT.Player != "undefined") {
                                                S = new YT.Player(bq, {
                                                    events: {
                                                        onStateChange: al,
                                                        onReady: function (Y) {
                                                            var T = Y.target.getVideoEmbedCode(), f = a2("#" + T.split('id="')[1].split('"')[0]), p = f.closest(".tp-caption"), V = p.data("videorate"), d = p.data("videostart");
                                                            if (V != aK) {
                            ...
                            h.data("interval", setInterval(function () {
                                if (h.data("metaloaded") == 1 || d.duration != NaN) {
                                    ...
                                    if (!h.hasClass("HasListener")) {
                                        ...
                                        var G = bF.find(".tp-vid-play-pause")[0], K = bF.find(".tp-vid-mute")[0], A = bF.find(".tp-vid-full-screen")[0], z = bF.find(".tp-seek-bar")[0], C = bF.find(".tp-volume-bar")[0];
                                        if (G != aK) {
                                            an(G, "click", function () {
                                                if (d.paused == true) {
                                                    d.play()
    ...
    var ai = function (b, a) {
        b.find(".rs-pendulum").each(function () {
            ...
            if (j.data("timeline") == aK) {
                ...
                var f = j.data("startdeg") == aK ? -20 : j.data("startdeg"), g = j.data("enddeg") == aK ? 20 : j.data("enddeg"), h = j.data("speed") == aK ? 2 : j.data("speed"), d = j.data("origin") == aK ? "50% 50%" : j.data("origin"), c = j.data("easing") == aK ? punchgs.Power2.easeInOut : j.data("ease");
                f = f * a;
                g = g * a;
                ...
                j.data("timeline").append(new punchgs.TweenLite.fromTo(j, h, {
                    ...
                    rotation: f, ease: c, onComplete: function () {
        ...
        b.find(".rs-rotate").each(function () {
            ...
            if (f.data("timeline") == aK) {
                ...
                var c = f.data("startdeg") == aK ? 0 : f.data("startdeg"), d = f.data("enddeg") == aK ? 360 : f.data("enddeg");
        ...
        b.find(".rs-slideloop").each(function () {
            ...
            if (l.data("timeline") == aK) {
                ...
                var g = l.data("xs") == aK ? 0 : l.data("xs"), h = l.data("ys") == aK ? 0 : l.data("ys"), k = l.data("xe") == aK ? 0 : l.data("xe"), d = l.data("ye") == aK ? 0 : l.data("ye"), c = l.data("speed") == aK ? 2 : l.data("speed"), j = l.data("easing") == aK ? punchgs.Power2.easeInOut : l.data("easing");
                g = g * a;
                h = h * a;
                k = k * a;
                d = d * a;
                l.data("timeline").append(new punchgs.TweenLite.fromTo(l, c, {force3D: "auto", x: g, y: h}, {
                    x: k,
                    y: d,
                    ease: j
                }));
                l.data("timeline").append(new punchgs.TweenLite.fromTo(l, c, {force3D: "auto", x: k, y: d}, {
                    x: g,
                    y: h,
                    onComplete: function () {
        ...
        b.find(".rs-pulse").each(function () {
            ...
            if (h.data("timeline") == aK) {
                ...
                var f = h.data("zoomstart") == aK ? 0 : h.data("zoomstart"), c = h.data("zoomend") == aK ? 0 : h.data("zoomend"), d = h.data("speed") == aK ? 2 : h.data("speed"), g = h.data("easing") == aK ? punchgs.Power2.easeInOut : h.data("easing");
                h.data("timeline").append(new punchgs.TweenLite.fromTo(h, d, {force3D: "auto", scale: f}, {
                    scale: c,
                    ease: g
                }));
                h.data("timeline").append(new punchgs.TweenLite.fromTo(h, d, {force3D: "auto", scale: c}, {
                    scale: f,
                    onComplete: function () {
        ...
        b.find(".rs-wave").each(function () {
            ...
            if (j.data("timeline") == aK) {
                j.data("timeline", new punchgs.TimelineLite);
                var f = j.data("angle") == aK ? 10 : j.data("angle"), g = j.data("radius") == aK ? 10 : j.data("radius"), h = j.data("speed") == aK ? -20 : j.data("speed"), d = j.data("origin") == aK ? -20 : j.data("origin");
                f = f * a;
                g = g * a;
                var c = {a: 0, ang: f, element: j, unit: g};
                j.data("timeline").append(new punchgs.TweenLite.fromTo(c, h, {a: 360}, {
                    a: 0,
                    force3D: "auto",
    ...
    var aE = function (f, c) {
        var a = 0;
        var b = f.find(".tp-caption"), d = c.container.find(".tp-static-layers").find(".tp-caption");
    ...
    var ac = function (v, j, b, m, z, g) {
        var y = v.data("timeline"), x = new punchgs.TimelineLite;
        var t = ak(), k = v.data("endspeed") == aK ? v.data("speed") : v.data("endspeed"), w = v.attr("class");
        ...
        if (c.slideamount > 1 && !(c.stopAfterLoops == 0 && c.stopAtSlide == 1)) {
            ...
            d.on("restarttimer", function () {
                ...
                if (c.stopLoop == "on" && c.next == c.lastslidetoshow - 1 || c.noloopanymore == 1) {
                    ...
                    f.data("tween").kill();
                    f.data("tween", punchgs.TweenLite.fromTo(f, c.delay / 1000, {width: "0%"}, {
                        force3D: "auto",
                        width: "100%",
                        ease: punchgs.Linear.easeNone,
                        onComplete: b,
    ...
    var aj = function (I, F, L, D) {
        ...
        F.lastslide = F.act;
        var P = I.find(">ul:first-child >li:eq(" + F.next + ")"), K = P.find(".slotholder"), R = K.data("bgposition"), M = K.data("bgpositionend"), G = K.data("zoomstart") / 100, Q = K.data("zoomend") / 100, A = K.data("rotationstart"), J = K.data("rotationend"), O = K.data("bgfit"), q = K.data("bgfitend"), U = K.data("easeme"), z = K.data("duration") / 1000, C = 100;
        if (O == aK) {
            O = 100
        }
        if (q == aK) {
        ...
        K.find(".defaultimg").each(function () {
            ...
            var h = au(F, R, O, g, k), c = au(F, M, q, g, k);
            if (k) {
                h.w = j / 100;
                c.w = t / 100
            }
            if (D) {
                ...
                var s = h.w, l = s * g.width() - F.width, b = s * g.height() - F.height, m = Math.abs(h.x / l * 100), r = Math.abs(h.y / b * 100);
                if (b == 0) {
                    r = 0
                }
                if (l == 0) {
                ...
                w.data("kenburn", punchgs.TweenLite.fromTo(g, z, {
                    ...
                    autoAlpha: 1, rotationZ: J, ease: U, x: c.x, y: c.y, scale: c.w, onUpdate: function () {
                        ...
                        var f = p * g.width() - F.width, n = p * g.height() - F.height, v = Math.abs(g[0]._gsTransform.x / f * 100), d = Math.abs(g[0]._gsTransform.y / n * 100);
                        if (n == 0) {
                            d = 0
                        }
                        if (f == 0) {
    ...
    var aO = function (a, b) {
        ...
        if (b.parallax == "mouse" || b.parallax == "scroll+mouse" || b.parallax == "mouse+scroll") {
            ...
            a.on("mousemove.hoverdir, mouseleave.hoverdir", function (k) {
                ...
                switch (k.type) {
                    case"mousemove":
                        var j = a.offset().top, n = a.offset().left, g = h.data("enterx"), d = h.data("entery"), m = g - (k.pageX - n), c = d - (k.pageY - j);
                        h.find(".tp-parallax-container").each(function () {
                            var l = a2(this), p = parseInt(l.data("parallaxlevel"), 0) / 100, f = m * p, o = c * p;
            ...
            if (aq()) {
                window.ondeviceorientation = function (k) {
                    var h = Math.round(k.beta || 0), f = Math.round(k.gamma || 0);
                    ...
                    var d = 360 / a.width() * f, c = 180 / a.height() * h;
                    g.find(".tp-parallax-container").each(function () {
                        var m = a2(this), p = parseInt(m.data("parallaxlevel"), 0) / 100, o = d * p, l = c * p;
                        punchgs.TweenLite.to(m, 0.2, {force3D: "auto", x: o, y: l, ease: punchgs.Power3.easeOut})
                    })
                }
            }
        }
    ...
    var a0 = function (v, g) {
        ...
        var b = v.offset().top, j = a2(window).scrollTop(), w = b + v.height() / 2, d = b + v.height() / 2 - j, q = a2(window).height() / 2, p = q - d;
        if (w < q) {
            p = p - (q - w)
        }
        var k = v.find(".current-sr-slide-visible");
        v.find(".tp-parallax-container").each(function (c) {
            var l = a2(this), f = parseInt(l.data("parallaxlevel"), 0) / 100, a = p * f;
            l.data("parallaxoffset", a);
            punchgs.TweenLite.to(l, 0.2, {force3D: "auto", y: a, ease: punchgs.Power3.easeOut})
        });
        if (g.parallaxBgFreeze != "on") {
            var h = g.parallaxLevels[0] / 100, m = p * h;
            punchgs.TweenLite.to(v, 0.2, {force3D: "auto", y: m, ease: punchgs.Power3.easeOut})
        }
    };
    var aV = function (k, h) {
        var f = k.parent();
        ...
        if (b < c) {
            ...
            g.parent().mouseenter(function () {
                var y = a2(this);
                var m = y.offset(), q = a2("body").data("mousex") - m.left, z = y.width(), n = y.find(".bullet:first").outerWidth(true), x = n * k.find(">ul:first >li").length, w = x - z + 15, v = w / z;
                y.addClass("over");
                q = q - 30;
                var p = 0 - q * v;
                if (p > 0) {
            ...
            g.parent().mousemove(function () {
                var y = a2(this), m = y.offset(), q = a2("body").data("mousex") - m.left, z = y.width(), n = y.find(".bullet:first").outerWidth(true), x = n * k.find(">ul:first >li").length - 1, w = x - z + 15, v = w / z;
                q = q - 3;
                if (q < 6) {
                    q = 0
                }
    ...
    var aC = function (k) {
        var q = k.parent().find(".tp-bullets.tp-thumbs .tp-mask .tp-thumbcontainer"), d = q.parent(), b = d.offset(), h = d.find(".bullet:first").outerWidth(true), v = d.find(".bullet.selected").index() * h, c = d.width(), h = d.find(".bullet:first").outerWidth(true), p = h * k.find(">ul:first >li").length, m = p - c, j = m / c, g = 0 - v;
        if (g > 0) {
            g = 0
        }
        if (g < 0 - p + c) {
