(function($) {
	...
	function headersearchStyle() {
		if($('.search-scroll-section.main-header').length){
			var scrollCLickLink = $('.scroll-to-top');
			var MainsearchHeader = $('.search-scroll-section.main-header');
			var windowpos = $(window).scrollTop();

			if (windowpos >= 360) {
				MainsearchHeader.addClass('fixed-header');
				scrollCLickLink.fadeIn(300);
			} else {
				MainsearchHeader.removeClass('fixed-header');
				scrollCLickLink.fadeOut(300);
			}
		}
	}
