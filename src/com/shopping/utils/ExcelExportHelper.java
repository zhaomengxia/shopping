...
public class ExcelExportHelper {
    ...
    public void exportExcelAndSave(String[] header,List<Object> excelList,String sheetTitle,
        ...
        //保存生成的Excel
        saveExcel(book,fileName,response);
    }
    ...
    public void exportExcelForBigDataAndSave(String[] header,List<Object> excelList,String sheetTitle,
                                             String flag,String fileName, HttpServletResponse response){
        //获取数据结果集
        ...
        for(int i = 0 ; i < books.size() ; i ++){
            ...
            //保存Excel文件
            saveExcel(book, _fileName,response);
        }
    }
     ...
     * @version 1.0
     */
    public static void saveExcel(HSSFWorkbook book, String fileName, HttpServletResponse response) {
